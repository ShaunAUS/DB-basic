...
class MemberServiceV3_1Test {
    ...
    private MemberServiceV3_1 memberSerivce;
    ...
    void befores() {
        ...
        PlatformTransactionManager transactionManager = new DataSourceTransactionManager(dataSource); //트랜잭션 매니저//JDBC구현체 주입
        memberSerivce = new MemberServiceV3_1(transactionManager,memberReposiotry);
    }
