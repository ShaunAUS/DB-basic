...
class MemberServiceV2Test {
    ...
    private MemberRepositoryV2 memberReposiotry;
    private MemberServiceV2 memberSerivce;

    @BeforeEach
    void befores() {
        DriverManagerDataSource dataSource = new DriverManagerDataSource(ConnectionConst.URL, ConnectionConst.USERNAME, ConnectionConst.PASSWORD);
        memberReposiotry = new MemberRepositoryV2(dataSource); //DB 커넥션
        memberSerivce = new MemberServiceV2(memberReposiotry,dataSource);
    }
